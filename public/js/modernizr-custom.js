/*!
 * modernizr v3.6.0
 * Build https://modernizr.com/download?-animation-arrow-atobbtoa-backgroundsize-bgpositionshorthand-bgpositionxy-bgrepeatspace_bgrepeatround-bgsizecover-blobconstructor-borderimage-borderradius-boxshadow-boxsizing-canvas-canvastext-canvaswinding-checked-cors-cssanimations-csscalc-csschunit-cssexunit-cssgradients-cssinvalid-csspointerevents-csspseudoanimations-csspseudotransitions-cssremunit-csstransforms-csstransforms3d-csstransitions-cssvalid-cssvhunit-cssvminunit-cssvwunit-cubicbezierrange-dataview-ellipsis-es5-es5array-es5date-es5function-es5object-es5string-es5syntax-es5undefined-eventlistener-flexbox-flexwrap-fontface-fullscreen-generatedcontent-generators-history-hsla-indexeddb-indexeddbblob-inlinesvg-json-lastchild-ligatures-mediaqueries-multiplebgs-nthchild-opacity-promises-queryselector-rgba-scriptasync-scriptdefer-scrollsnappoints-sessionstorage-strictmode-svg-svgasimg-svgclippaths-svgfilters-target-textalignlast-textshadow-todataurljpeg_todataurlpng_-unicode-webgl-websockets-xhrresponsetype-xhrresponsetypearraybuffer-xhrresponsetypeblob-xhrresponsetypedocument-xhrresponsetypetext-setclasses-dontmin-cssclassprefix:modern-
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
...
/*!
{
  ...
  "property": ["todataurljpeg", "todataurlpng"],
  "tags": ["canvas"],
